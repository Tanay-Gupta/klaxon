...
class BountyDetailBody extends StatefulWidget {
  final BountyModel contest;

  const BountyDetailBody({super.key, required this.contest});

  @override
  State<BountyDetailBody> createState() => _ContestDetailBodyState();
}

class _ContestDetailBodyState extends State<BountyDetailBody>
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInfoCard([
                ...
                _buildInfoTile("Bounty Amount", "${contest.amount}\$"),
              ]),
