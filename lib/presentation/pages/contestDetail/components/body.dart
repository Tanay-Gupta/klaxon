...
class ContestDetailBody extends StatefulWidget {
  final ContestModel contest;

  const ContestDetailBody({super.key, required this.contest});

  @override
  State<ContestDetailBody> createState() => _ContestDetailBodyState();
}

class _ContestDetailBodyState extends State<ContestDetailBody>
